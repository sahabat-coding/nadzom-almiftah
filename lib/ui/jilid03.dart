...
class Jilid03 extends StatefulWidget {
  const Jilid03({super.key});

  @override
  // ignore: library_private_types_in_public_api
  _Jilid03State createState() => _Jilid03State();
}

class _Jilid03State extends State<Jilid03> {
            ...
            child: ListView(
              children: [
                _TextWithBorderAndDottedLine(
                  text: '1. FIIL MU`ROB DAN MABNI',
                  audioUrl: 'Jilid3/Fi_il Mu_rob dan Mabni.mp3',
                  onPlayPause: _togglePlayPause,
                  isCurrentPlaying: _currentPlayingAudio ==
                      'Jilid3/Fi_il Mu_rob dan Mabni.mp3',
                ),
                const SizedBox(height: 8),
                _TextWithBorderAndDottedLine(
                  text: '2. AF`ALUL KHOMSAH',
                  audioUrl: 'Jilid3/Fil-fil Yang Lima.mp3',
                  onPlayPause: _togglePlayPause,
                  isCurrentPlaying:
                      _currentPlayingAudio == 'Jilid3/Fil-fil Yang Lima.mp3',
                ),
                const SizedBox(height: 8),
                _TextWithBorderAndDottedLine(
                  text: '3. AMIL NASHOB UNTUK FIIL MUDZORI`',
                  audioUrl: 'Jilid3/Amil Nashob.mp3',
                  onPlayPause: _togglePlayPause,
                  isCurrentPlaying:
                      _currentPlayingAudio == 'Jilid3/Amil Nashob.mp3',
                ),
                const SizedBox(height: 8),
                _TextWithBorderAndDottedLine(
                  text: '4. AMIL JAZM',
                  audioUrl: 'Jilid3/Amil Jazm.mp3',
                  onPlayPause: _togglePlayPause,
                  isCurrentPlaying:
                      _currentPlayingAudio == 'Jilid3/Amil Jazm.mp3',
                ),
                const SizedBox(height: 8),
                _TextWithBorderAndDottedLine(
                  text: '5. HURUF-HURUF ILLAT',
                  audioUrl: 'Jilid3/Huruf-huruf Illat.mp3',
                  onPlayPause: _togglePlayPause,
                  isCurrentPlaying:
                      _currentPlayingAudio == 'Jilid3/Huruf-huruf Illat.mp3',
                ),
              ],
            ),
          ),
